...
//  Tinder
//
//  Created by myllena.r.almeida on 01/05/20.
//  Copyright © 2020 myllena.r.almeida. All rights reserved.
//
...
class UserService {
    static let shared  = UserService()
      ...
      let users: [User] = [
        User(id: 101, name: "José Silva", age: 19, match: true, description: "O último a dar match chama", photo: "pessoa-1"),
        User(id: 102, name: "Lucas Santos", age: 25, match: false, description: "Deu like sem querer?", photo: "pessoa-2"),
         User(id: 103, name: "Luiz Fernando", age: 24, match: false, description: "Acho q a gente combina", photo: "pessoa-3"),
...
//        User(id: 108, name: "Sandra Souza", age: 24, match: true, description: "Fotos sem camisa não me impressionam", photo: "pessoa-8"),
